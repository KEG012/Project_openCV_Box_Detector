...
while True:
    ...
    cv2.imshow("Camera 1 - Sobel Edge Detection", edged_out1)
    cv2.imshow("Camera 1 - Result", result_frame1)
    cv2.imshow("Camera 2 - Sobel Edge Detection", edged_out2)
    cv2.imshow("Camera 2 - Result", result_frame2)
